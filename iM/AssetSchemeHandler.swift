//
//  AssetSchemeHandlerHandler.swift
//  iM
//
...
nonisolated final class AssetSchemeHandler: NSObject, WKURLSchemeHandler {
    ...
    nonisolated static func resolveVendor(_ url: URL) -> URL? {
        ...
        let bundles = [Bundle.main, Bundle(for: AssetSchemeHandler.self)]
